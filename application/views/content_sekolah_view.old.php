    ...
    <div id="content"> 
		<div id="home" class="section">
            ...
            <div class="box home_box1 color2">
	            <a href="#tugas"><img src="<?php echo base_url(); ?>images/jumat.jpg" alt="Jumat" /></a>
            </div>
        ...
        <div class="section section_with_padding" id="tauqid"> 
            ...
            foreach($rows as $row)
            {
                if ($row->subkategori!='Tauqid' || $row->status=='Not Published') continue;
                $i++;
            }
        ...
        <div class="section section_with_padding" id="aqidah"> 
            ...
            foreach($rows as $row)
            {
                if ($row->subkategori!='Aqidah' || $row->status=='Not Published') continue;
                $i++;
            }
            $j = 0;
            ?>
        ...
        <div class="section section_with_padding" id="kesangyangan"> 
            ...
            foreach($rows as $row)
            {
                if ($row->subkategori!='Kesangyangan' || $row->status=='Not Published') continue;
                $i++;
            }
            $j = 0;
            ?>
        ...
        <div class="section section_with_padding" id="laduni"> 
            ...
            foreach($rows as $row)
            {
                if ($row->subkategori!='Laduni' || $row->status=='Not Published') continue;
                $i++;
            }
            $j = 0;
            ?>
        ...
        <div class="section section_with_padding" id="umum"> 
            ...
            foreach($rows as $row)
            {
                if ($row->subkategori!='Umum' || $row->status=='Not Published') continue;
                $i++;
            }
            $j = 0;
            ?>
        ...
        <div class="section section_with_padding" id="news"> 
            ...
            foreach($rows as $row)
            {
                if ($row->news==0 || $row->status=='Not Published' ) continue;
                $i++;
            }
            $j = 0;
            ?>
