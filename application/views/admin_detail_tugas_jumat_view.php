<section id="middle">
    ...
    <div class="grid-1">
        <form action="<?=base_url();?>administratorPA/updatetugasjumat" method="post"  name="updatedetailtugasjumat">
    ...
    <div id="wysihtml5-editor-toolbar">
        <div class="floatdropdownartikel">
          <select name="subkategori" class="dropdownartikel">
