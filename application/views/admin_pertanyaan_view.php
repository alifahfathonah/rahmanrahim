					...
					<div class="indent">  
						<h2>Data Pertanyaan</h2>
                                                    ...
                                                    <table width="900" border="1"  bordercolor="#000000" bocellspacing="0" cellpadding="2" align="center" style="color: black">
                                                      <tr>
                                                        <td><div align="center">ID_Pertanyaan</div></td>
                                                        ...
                                                        <td><div align="center">Jawab Pertanyaan</div></td>
                                                        <td><div align="center">Ubah Status</div></td>
                                                      </tr>
                                                      <?php foreach($rows as $baris) : ?>
                                                      <tr>
                                                          <td><div align="center"><?php echo $baris->id_pertanyaan; ?></div></td>
                                                        <td><div align="center"><?php echo $baris->nama; ?></div></td>
                                                        <td><div align="center"><?php echo $baris->pertanyaan; ?></div></td>
                                                        <td><div align="center"><?php echo $baris->jawaban; ?></div></td>
                                                        <td><div align="center"><?php echo $baris->tanggal; ?></div></td>
                                                        <td><div align="center"><?php echo $baris->status; ?></div></td>
                                                        <td><div align="center"><a href="<?php echo base_url()."administratorPA/jawab/".$baris->id_pertanyaan; ?>">Jawab</a></div></td>
                                                        <td><div align="center"><a href="<?php echo base_url()."administratorPA/ubah_status/".$baris->id_pertanyaan; ?>">Ubah</a></div></td>
                                                      </tr>
                                                      <?php endforeach; ?>
                                                    </table>
                                                    <br/>
