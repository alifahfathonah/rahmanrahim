...
<!-- content -->
			<section id="content">
				<div class="padding">
					<div class="indent">
						<h2>Tanya Jawab<figure class="img-indent3"><img src="<?php echo base_url(); ?>images/page1-img1.png" alt="" width="80px"/></figure></h2>
						<?php if(isset($rows)):?>
							...
							<div class="col-3">
								<div class="wrapper">
										...
										<h6><strong>Pertanyaan dari <?php echo $baris->nama; ?></strong></h6>
										<p align="justify">
